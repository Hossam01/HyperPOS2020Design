...
class CL_main(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        try:
            ...
            self.QAct_Report_Promotion_1.clicked.connect(self.FN_search_reporting)
            self.QAct_Report_Promotion_2.clicked.connect(self.FN_search_reporting1)
